export default function ContactForm() {
  return (
    <div className="flex min-h-[50vh] items-center justify-start">
      <div className="mx-auto w-full max-w-lg">
        ...
        <form action="https://api.web3forms.com/submit" className="mt-10">
          ...
          <button type="submit" className="mt-5 rounded-md bg-black px-10 py-2 text-black-90 text-2xl">Send Message</button>
        </form>
      </div>
    </div>
  )
